...
import '../../../assets/css/routes/search/SlideTypeRelation.css';
...
class SlideTypeRelation extends React.Component {
    constructor(props) {
        super(props);
                            ...
                            <div className="slideWrapper" style={{'--page':this.state.slideTo,'width':(this.state.slideItem.length * this.itemWidth) + (this.state.slideItem.length * this.itemMargin)}}>
                                {
                                    this.state.slideItem.map((data, i) => {
                                        return(
                                            <SlideTypeRelationItem
                                                relation={data.relatedSearch}
                                                key = {i}
                                                index = {i}
                                                items={this.items}
...
SlideTypeRelation.propTypes = {
    loadFocus: PropTypes.string
};

class SlideTypeRelationItem extends React.Component {
    focusOn(...args){
...
export default SlideTypeRelation;