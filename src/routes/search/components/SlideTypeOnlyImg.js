...
import '../../../assets/css/routes/search/SlideTypeOnlyImg.css';
	...
	render() {
		return (
			<div className="contentGroup">
				<div className="slideTypeOnlyImg">
...
class SlideTypeOnlyImgItem extends React.Component {
	focusOn(...args){
