...
class G2RotateMenuItem extends Component {
    ...
    render() {
        ...
        console.log(`포커스 정보 idx : ${idx} + ' pos : ${pos}`);
        return (
...
class CharaterRotateSlider extends Component {
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        // 빈 화면
        const blank = (
            <div className="characterSlide" style={slideStyle}></div>
        );

        return (
            <div className={focusClass} style={{ transform: 'translate(0px, 0px)', backgroundColor: '#F88' }}> {/* 포커스시 focus 추가*/}
                <div className="dim" />
                <div className="characterSlideInner">
                    <div className="contentGroup">
                        { _.isEmpty(fakeChildren) ? blank : listView }
                    </div>
                </div>
            </div>
        );
...
export { CharaterRotateSlider, G2RotateMenuItem };