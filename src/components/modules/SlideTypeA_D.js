...
import '../../assets/css/components/modules/SlideTypeA_D.css';
...
class SlideTypeA_D extends SlideTypeA {
	constructor(props) {
		super(props);
	...
	render() {
		return(
			<div className={this.props.allView && this.props.index === 0 ? "slide first":"slide"}>
				<div to="/home/genre/Type1" ref="slideItem" className={this.props.index === ITEMS + this.props.slideTo - 1 ? "csFocus right": this.props.index === this.props.slideTo ? "csFocus left" : "csFocus"} tabIndex="-1" onFocus={this.focusOn.bind(this)} onKeyDown={this.keyDown.bind(this)}>
