...
import '../../assets/css/components/modules/SlideTypeB_C.css';
...
class SlideTypeB_C extends SlideTypeB {
	constructor(props) {
		super(props);
...
class SlideTypeB_CItem extends React.Component {
	focusOn(...args){
	...
	render() {
		return(
			<div className={this.props.index < this.props.items || this.props.index >= this.props.maxLength - this.props.items ? "slide":"slide"}>
				<div to={this.props.link} className={this.props.index === ITEMS + this.props.slideTo - 1 ? "csFocus right": this.props.index === this.props.slideTo ? "csFocus left" : "csFocus"} tabIndex="-1" onFocus={this.focusOn.bind(this)} onKeyDown={this.keyDown.bind(this)}>
